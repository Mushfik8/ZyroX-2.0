...
const phases = [
  {
    ...
    progress: 85,
    items: [
      { text: 'Core team assembly', done: true },
      { text: 'Whitepaper & tokenomics design', done: true },
  ...
  },
  {
    ...
    progress: 40,
    items: [
      { text: 'Smart contract development (BSC)', done: true },
      { text: 'Security audit by CertiK', done: false },
      { text: 'Private sale & partnerships', done: false },
  ...
  },
  {
    ...
    progress: 0,
    items: [
      { text: 'BSC contract deployment', done: false },
  ...
  },
  {
    ...
    progress: 0,
    items: [
      { text: 'Play-to-earn game beta', done: false },
      { text: 'NFT marketplace launch', done: false },
      { text: 'Cross-chain bridge deployment', done: false },
      { text: 'DAO governance activation', done: false },
    ]
  }
]

...
export default function DataHub() {
  return (
    <section className="system-node" id="data">
      <div className="node-container">
        
        <div className="data-header">
          <span className="sys-badge">NODE 03 // GLOBAL TELEMETRY</span>
          <h2 className="sys-title">NETWORK <span style={{ color: 'var(--neon-green)' }}>STATE</span></h2>
        </div>

        <div className="telemetry-grid">
          <div className="telemetry-main holo-panel">
          ...
          <div className="telemetry-side">
            <div className="holo-panel stat-box">
      ...
      <style>{`
        .data-header { text-align: right; margin-bottom: 40px; display: flex; flex-direction: column; align-items: flex-end; }
        ...
        @media (max-width: 1024px) {
          ...
          .data-header { align-items: flex-start; text-align: left; }
        }
      `}</style>
    </section>
  )
